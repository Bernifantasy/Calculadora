...
loginForm.addEventListener("submit", (e)=>{
    ...
    if (nom && calculadora) {
        ...
        if (calculadora === "simple") {
            window.location.href = "Calculadora/html/calculadora_simple.html";  // Redirigir a la página de calculadora simple
        } else if (calculadora === "cientifica") {
            window.location.href = "Calculadora/html/calculadora_cientifica.html";  // Redirigir a la página de calculadora científica
        }
    } else {
